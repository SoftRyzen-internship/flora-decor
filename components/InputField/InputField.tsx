  ...
  return (
    <div className="relative flex flex-col gap-1">
      ...
      <input
        ...
        className={`box-border rounded-[10px] border-2  utilities focus:border-[#8EA58E] ${type === 'textarea' ? 'resize-none h-[150px]' : ''} outline-none ${errors[name] ? 'border-error' : 'border-transparent'} px-4 py-[16px] w-full font-geologica text-[16px] leading-[1.3] font-medium md:text-subtitleMd text-main placeholder:text-placeholder `}
      />
      {errors[name] && (
