...
export const Footer = () => {
  ...
  return (
    <footer className="relative border-container pt-[60px] pb-[30px] bg-main text-center">
      <Container>
        <Logo isFooter />
        <div className="flex flex-col gap-[15px] items-center mb-[35px]">
          ...
          <ul className="flex gap-5 justify-center">
            {deliveryIcons.map(item => (
              <li key={item.name}>
                ...
                {item.name === 'nova' && <IconNova width={100} height={36} />}
              </li>
            ))}
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="flex gap-5 justify-center mb-[15px]">
            {companyIcons.map(item => (
              <li key={item.name}>
                ...
                >
                  ...
                  {item.name === 'softryzen' && (
                    <IconSoftRyzen className="w-[100px] h-[15px] md:w-[270px] md:h-6 xl:w-[134px] xl:h-[19px]" />
                  )}
                </a>
              </li>
            ))}
